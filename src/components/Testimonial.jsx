    ...
    <div>
     <section className=" py-12 px-6 text-center">
      <div className="max-w-2xl mx-auto">
        <h2 className="text-2xl font-bold ">🚀 Exciting Opportunities Ahead!</h2>
        <p className="mt-4 ">
          We are launching a platform for <span className="font-semibold text-blue-600">professional jobs</span> and <span className="font-semibold text-blue-600">freelancing careers</span>.  
          Get ready to explore high-paying remote jobs and the best freelancing opportunities in the industry!
        </p>
      </div>
    </section>
